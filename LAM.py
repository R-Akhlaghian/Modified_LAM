...
class_name = input('enter class name (e.g.: SwinIR):\n')
...
img_lr, img_hr = prepare_images('content/LAM_Demo/test_images/6.png')  # Change this image name
...
# ------------------------
img_tensor = tensor_hr.unsqueeze(0)
